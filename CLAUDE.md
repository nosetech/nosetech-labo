...
プロジェクト全体で統一されたレスポンシブブレークポイントを使用します：

- **モバイル**: ~700px
- **タブレット**: 700px~1024px
- **デスクトップ**: 1024px~

CSSメディアクエリの記述時は、`max-width: 700px`（モバイル）と`max-width: 1024px`（タブレット以下）をメインに使用してください。

## GitHubでのコミュニケーション

- **作成するIssueやPull Requestは必ず日本語で記載してください**
- Issue/PRのタイトル、説明文、コメントはすべて日本語で統一
- コミットメッセージも日本語で記述してください
- 技術用語はそのまま英語で記載して問題ありません
